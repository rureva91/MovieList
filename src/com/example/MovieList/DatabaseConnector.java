...
public class DatabaseConnector 
{
   ...
   public long insertMovie(String name, String director, String music,  
		      String language, String releasedate, String actress, String actor) 
   {
      ContentValues newMovie = new ContentValues();
      newMovie.put("name", name);
      newMovie.put("director", director);
      newMovie.put("music", music);
   ...
   public void updateMovie(long id, String name, String director, String music,  
		      String language, String releasedate, String actress, String actor) 
   {
      ContentValues editMovie = new ContentValues();
      editMovie.put("name", name);
      editMovie.put("director", director);
      editMovie.put("music", music);
      ...
      public void onCreate(SQLiteDatabase db) 
      {
         ...
         // query to create a new table named movies
          String createQuery = "CREATE TABLE movies" +
                  ...
                  "name TEXT, director TEXT, music TEXT, " +
                  "language TEXT, releasedate TEXT, actress TEXT, actor TEXT);";
